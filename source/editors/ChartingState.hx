...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Ghost Trans In', "Starts the transitions between ghosts"],
		['Ghost Trans Out', "Ends the transitions between ghosts"],
		['Ghost Eyes', "Plays the eye animation for ghosts,\nValue 1: name of the ghost."],
